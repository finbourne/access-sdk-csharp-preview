...
namespace Finbourne.Access.Sdk.Model
{
    ...
    public partial class PolicyTemplateCreationRequest : IEquatable<PolicyTemplateCreationRequest>
    {
        /// <summary>
        ...
        public PolicyTemplateCreationRequest(string code = default(string), string displayName = default(string), string description = default(string), List<PolicyTemplatedSelector> templatedSelectors = default(List<PolicyTemplatedSelector>))
        {
            ...
            this.Code = code ?? throw new ArgumentNullException("code is a required property for PolicyTemplateCreationRequest and cannot be null");
            // to ensure "displayName" is required (not null)
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for PolicyTemplateCreationRequest and cannot be null");
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for PolicyTemplateCreationRequest and cannot be null");
            // to ensure "templatedSelectors" is required (not null)
            this.TemplatedSelectors = templatedSelectors ?? throw new ArgumentNullException("templatedSelectors is a required property for PolicyTemplateCreationRequest and cannot be null");
        }
