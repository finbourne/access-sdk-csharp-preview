...
namespace Finbourne.Access.Sdk.Api
{
    ...
    public interface IPolicyTemplatesApiSync : IApiAccessor
    {
        ...
        ResourceListOfPolicyTemplateResponse ListPolicyTemplates(DateTimeOffset? asAt = default(DateTimeOffset?), string sortBy = default(string), int? limit = default(int?), string filter = default(string), string page = default(string));
        ...
        ApiResponse<ResourceListOfPolicyTemplateResponse> ListPolicyTemplatesWithHttpInfo(DateTimeOffset? asAt = default(DateTimeOffset?), string sortBy = default(string), int? limit = default(int?), string filter = default(string), string page = default(string));
        /// <summary>
    ...
    public partial class PolicyTemplatesApi : IPolicyTemplatesApi
    {
        ...
        /// <param name="page">Optional. Paging token returned from a previous result (optional)</param>
        /// <returns>ResourceListOfPolicyTemplateResponse</returns>
        public ResourceListOfPolicyTemplateResponse ListPolicyTemplates(DateTimeOffset? asAt = default(DateTimeOffset?), string sortBy = default(string), int? limit = default(int?), string filter = default(string), string page = default(string))
        {
        ...
        /// <param name="page">Optional. Paging token returned from a previous result (optional)</param>
        /// <returns>ApiResponse of ResourceListOfPolicyTemplateResponse</returns>
        public Finbourne.Access.Sdk.Client.ApiResponse<ResourceListOfPolicyTemplateResponse> ListPolicyTemplatesWithHttpInfo(DateTimeOffset? asAt = default(DateTimeOffset?), string sortBy = default(string), int? limit = default(int?), string filter = default(string), string page = default(string))
        {
            Finbourne.Access.Sdk.Client.RequestOptions localVarRequestOptions = new Finbourne.Access.Sdk.Client.RequestOptions();
        ...
        {
            Finbourne.Access.Sdk.Client.ApiResponse<ResourceListOfPolicyTemplateResponse> localVarResponse = await ListPolicyTemplatesWithHttpInfoAsync(asAt, sortBy, limit, filter, page, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
